...
class Ticket extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'ticket/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'ticket/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'ticket/index.html';
            $config['first_url'] = base_url() . 'ticket/index.html';
        }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-12-22 07:40:55 */
/* http://harviacode.com */